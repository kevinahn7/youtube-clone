...
class Results extends React.Component {
	...
	render() {
		...
		return (
			<div style={this.resultsStyle} onClick={() => this.handleScroll(currentSearch.searchQuery, currentSearch.pageToken)} ref={(scroller) => {this.scroller = scroller;}}>
				...
				<div style={this.resultItemsStyle}>
					{/* <InfiniteScroll
						pageStart={0}
						loadMore={loadMore(currentSearch.searchQuery, currentSearch.pageToken)}
						hasMore={true}
						threshold={4000}
